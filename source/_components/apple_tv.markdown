...
The `apple_tv` platform allows you to control an Apple TV (3rd and 4th generation). See the [remote platform](/components/apple_tv/) if you want to send remote control buttons, e.g., arrow keys.
